...
ADD entrypoint.sh le-ipmi.sh supermicro-ipmi-updater.py asrock_ipmi_cert_updater.py /home/lego/
RUN chmod +x /home/lego/entrypoint.sh /home/lego/le-ipmi.sh
